...
# ======================================================
#  PHASE B MASTER v19: TRUE GEOMETRIC DENSITY REGIME
...
#  New in v19: Mathematically rigorous rasterized obstacle density
# ======================================================

class SwarmLidarEnv_v19_GeometricDensity(ParallelEnv):
    metadata = {'render_modes': ['human'], "name": "swarm_lidar_v19_geometric"}
    ...
    def reset(self, seed=None, options=None):
        ...
        while True:
            ...
            # --- v19 GEOMETRIC OBSTACLE GENERATION ---
            gen_result = self._generate_obstacles(self.target_density, drone_clearance)
            if gen_result is None:
                continue # Failed to achieve guaranteed density, discard entire map and restart
                
            self.obstacles, self.actual_density, occupied_grid = gen_result
            
            # --- Connectivity Validation ---
            if self._is_map_solvable(occupied_grid):
                break # Map is valid!
            # Else, discard and regenerate entire map
    ...
    def _generate_obstacles(self, density, drone_clearance):
        ...
        return obstacles, achieved_density, occupied
