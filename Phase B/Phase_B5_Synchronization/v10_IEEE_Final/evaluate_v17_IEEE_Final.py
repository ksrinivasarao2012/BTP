...
def run_episode_batch_worker(args):
    ...
    if obs_dim == 752:
        ...
        env = SwarmLidarEnv_v17_Master(render_mode=None, target_density=target_density)
...
def save_evaluation_plots(df, fold_df, timestamp, results_dir):
    try:
        ...
        plt.tight_layout()
        bar_path = os.path.join(results_dir, f"v17_master_evaluation_chart_{timestamp}.png")
        ...
        plt.tight_layout()
        box_path = os.path.join(results_dir, f"v17_master_boxplot_{timestamp}.png")
        ...
        plt.tight_layout()
        t_path = os.path.join(results_dir, f"v17_master_throughput_{timestamp}.png")
...
if __name__ == "__main__":
    ...
    default_model = r"d:\Swarm\BTP\models\v17_Master_Final.zip"
    ...
    if not os.path.exists(m_path):
        ...
        print("Usage: python evaluate_v17_IEEE_Final.py <model_path> [cores] [eps_per_fold] [num_folds] [density]")
        sys.exit(1)
