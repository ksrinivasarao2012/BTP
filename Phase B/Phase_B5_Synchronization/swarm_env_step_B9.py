...
# ======================================================
#  PHASE B9: TOPOLOGICAL PATH GUIDANCE & CTDE
#  Replaces Euclidean observations/rewards with 1-to-1
#  Topological Shortest-Path equivalents computed via
#  Dijkstra's Algorithm. Prevents backtracking lockups.
# ======================================================
class SwarmLidarEnv_StepB9(ParallelEnv):
    metadata = {'render_modes': ['human'], "name": "swarm_lidar_stepB9_v0"}
