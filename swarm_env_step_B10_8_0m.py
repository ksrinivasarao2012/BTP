...
class SwarmLidarEnv_StepB10_8_0m(ParallelEnv):
    ...
    def __init__(self, render_mode=None, target_density=0.20, drone_radius=0.15, safety_radius=0.19, communication_range=8.0, use_congestion=True, congestion_mode="env"):
        super().__init__()
