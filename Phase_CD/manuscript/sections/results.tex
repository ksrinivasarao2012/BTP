...
% EXCEPTION: the probe AUC (0.99 oracle / 0.85-0.90 realistic, sec:res-temporal)
% is a 150-map feasibility number, labelled as such in the text; replace with
% the 500-map values if/when the probe rerun (run_rerun_verification.bat) lands.
...
nearest-obstacle association (both figures measured over 150 maps in
feasibility testing, ahead of the 500-map camera-ready protocol used
