...
can engineer disagreements to make the defense expel \emph{honest} agents.
...
systematic bias is a concern, and even then the harm is bounded by the same
own-sensing cushion that keeps no-harm near zero. Distinguishing such a bias
...
bias test would separate the two --- which we leave to future work.
