...
swarms, and with an advantage that grows as the number of traitors grows. A
...
space --- a stealth/harm bind we verify across noise levels and traitor
counts. Notably, no learned trust component is required.
