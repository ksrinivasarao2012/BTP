"""
Density Sweep for v14 Parameters (10,000 Maps)
Evaluates solvability for the 3 successful densities:
- 0.20
- 0.25
- 0.30
using 10,000 random maps per density to obtain high-precision statistical validation.
Utilizes chunked parallel processing across all available CPU cores to maximize performance.
"""
...
def main():
    ...
    csv_path = Path(__file__).parent / f"density_sweep_v14_10000maps_results_{timestamp}.csv"
